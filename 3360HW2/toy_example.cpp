...
sid = semget(123,2,IPC_CREAT | 0666); //declaring the semaphore 
//1st arguement is the id 
//2nd argument determines number of semaphores made in this case 2 are made
//3rd is a flag
